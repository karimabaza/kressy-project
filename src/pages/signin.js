...
const SignIn = (props) => {
  ...
  return (
    <>
      <div className="sign-container container-fluid h-100">
        <div class="row justify-content-center h-100 align-items-center">
          <div className="col-md-5 text-center">
            <div className="auth-pages-img">
              <img className="" src={SignInLogo} alt=" " />
            </div>
          </div>
          <div className="col-md-5">
            <div style={{ textAlign: "start" }} className="login-inputs-container">
              ...
              <div className="google-container">
                ...
                <span className="google-text">Signin with Google</span>
              </div>
              <div className="apple-container">
                <span className="google">
                  <BsApple />
                </span>
                <span className="google-text">Signin with Apple</span>
              </div>
              <div className="facebook-container">
                <span className="google">
                  <FaFacebookF />
                </span>
                <span className="google-text">Signin with Facebook</span>
              </div>
              <p className="or">or</p>
              <hr />
            ...
            <div className="dont-have-account">
              ...
              <Link onClick={() => gotosignup()} className="forget-password">
                Sign up
              </Link>
            </div>
            </div>
